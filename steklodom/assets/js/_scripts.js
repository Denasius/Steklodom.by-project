jQuery(document).ready(function(){
    ...
    jQuery('.primary-menu-xs').prepend('<div class="overlay"></div>');
    jQuery('.open-menu').on('click', function(){
        jQuery('.overlay,.top-menu').addClass('active');
    });
    jQuery('.sub .btns').on('click', function(){
        jQuery('.overlay,.top-main-menu').addClass('active');
    });
    
    jQuery('.overlay').on('click', function(){
        jQuery('.overlay,.top-menu,.top-main-menu').removeClass('active');
    });

    jQuery('.primary-menu-xs .sub .top-main-menu ul li ul').parent('li').prepend('<span class="arrow-down"></span>');
    jQuery('.arrow-down').on('click', function(){
        jQuery(this).siblings('ul').toggleClass('active').parent('li').siblings('li').children('ul').removeClass('active');
    });
